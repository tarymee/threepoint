<template>
  <div>
    <a class="store" @click="contact(item.phone)" v-for="(item, index) in storeArr" :key="index">
      ...
      <div class="store-price"><div class="store-price-price1">优选价: </div><div class="store-price-price2">￥</div><div class="store-price-price3">{{item.discountPrice}}</div></div>
      <div class="store-del">原价：￥{{item.marketPrice}}</div>
    </a>
